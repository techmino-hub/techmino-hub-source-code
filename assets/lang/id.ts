...
![Tabel B2B2B Techmino](/img/faq/b2b2b-calculator.png)`,
  ...
  map: {
    tabTitle: "Peta - Techmino Hub",
    tabTitleFS: "Peta (Fullscreen) - Techmino Hub",
    title: "Peta Techmino",
    details: "Jenis map: '{currentMap}'",
    fullscreen: "Buka peta fullscreen",
    noscriptWarn: "Sepertinya JavaScript tidak bisa jalan. Untuk versi peta yang tidak membutuhkan JavaScript, coba kunjungi peta lite.",
    liteVersion: "Buka peta lite",
    rankReqs: "Persyaratan rank: {0}",
    ...
    tooltip: {
      rank: {
        ...
        S: "Rank S",
        A: "Rank A",
        B: "Rank B (minimum untuk meng-unlock mode-mode lain)",
        Q: "Persyaratan kualifikasi (minimum yang diperlukan agar skor terdaftar di leaderboard)",
      },
      expand: "Lihat info lebih lanjut",
      close: "Tutup",
      back: "Kembali",
    },
    info: {
      difficulty: "Kesulitan",
      length: "Lama permainan",
      version: "Tersedia pada",
      source: "Lihat kode sumber"
    },
    loadingArticle: "Memuat artikel...",
    noArticle: "Artikel tidak tersedia",
    featuredVideo: "Video demonstrasi: {0}",
    lagWarnPre: "Nge-lag? ",
    mobileWarnPre: "Menggunakan HP? ",
    liteLink: "Versi lite",
    impossibleRankReq: "(mustahil)",
  },
  mapLite: {
    tabTitle: "Peta (Lite) - Techmino Hub",
    tabTitleModeDetail: "Tentang mode {modeName} - Techmino Hub",
    backToMap: "Kembali ke peta",
    modeDesc: "Deskripsi: {0}",
  },
  modes: {
    sprint_10l: {
      title: "Sprint",
